...
def append_details(
    fold_log, frequency_log, stage, window, n_points, bit_length, result
):
...
def main():
    ...
    for bit_length in ID_BIT_LENGTHS:
        ...
        summaries, fold_log, frequency_log, stage1 = [], [], [], []
        ...
        for start_hz, end_hz in CANDIDATE_WINDOWS:
            ...
            append_details(
                fold_log, frequency_log, "1_Window_Selection", window,
        ...
        for item in top_windows:
            ...
            for n_points in STAGE2_N_POINTS:
                ...
                append_details(
                    fold_log, frequency_log, "2_Sampling_Reduction",
